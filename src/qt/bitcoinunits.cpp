...
QString BitcoinUnits::name(int unit)
{
    ...
    case uBTC: return QString::fromUtf8("μGRC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("GoldRushCoins");
    case mBTC: return QString("Milli-GoldRushCoins (1 / 1,000)");
    case uBTC: return QString("Micro-GoldRushCoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
